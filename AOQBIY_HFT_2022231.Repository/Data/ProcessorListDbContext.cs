    ...
    public partial class ProcessorListDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Processor>().HasData(new Processor[] 
            {
                ...
                new Processor() { ProcessorId = 2, BrandId = 1, ChipsetId = 2, PerformanceCores = 8, EfficencyCores = 8, TotalThreads = 24, MaxTurboFrequency = 5.5, Cache = 30, IntegratedGraphics = true, Name = "Intel Core i9-12900KS Processor" },
                ...
                new Processor() { ProcessorId = 4, BrandId = 1, ChipsetId = 4, PerformanceCores = 10, EfficencyCores = 0, TotalThreads = 20, MaxTurboFrequency = 5.3, Cache = 20, IntegratedGraphics = true, Name = "Intel Core i9-10900K Processor" },
                ...
                new Processor() { ProcessorId = 6, BrandId = 1, ChipsetId = 5, PerformanceCores = 6, EfficencyCores = 0, TotalThreads = 12, MaxTurboFrequency = 4.8, Cache = 12, IntegratedGraphics = true, Name = "Intel Core i9-8950HK Processor" },
                ...
                new Processor() { ProcessorId = 8, BrandId = 1, ChipsetId = 2, PerformanceCores = 8, EfficencyCores = 4, TotalThreads = 20, MaxTurboFrequency = 5.0, Cache = 25, IntegratedGraphics = true, Name = "Intel Core i9-12700K Processor" },
                ...
                new Processor() { ProcessorId = 10, BrandId = 1, ChipsetId = 4, PerformanceCores = 8, EfficencyCores = 0, TotalThreads = 16, MaxTurboFrequency = 5.1, Cache = 16, IntegratedGraphics = true, Name = "Intel Core i9-10700K Processor" },
                ...
                new Processor() { ProcessorId = 12, BrandId = 1, ChipsetId = 6, PerformanceCores = 6, EfficencyCores = 0, TotalThreads = 12, MaxTurboFrequency = 4.7, Cache = 12, IntegratedGraphics = true, Name = "Intel Core i7-8700K Processor" },
                ...
                new Processor() { ProcessorId = 14, BrandId = 1, ChipsetId = 2, PerformanceCores = 8, EfficencyCores = 4, TotalThreads = 20, MaxTurboFrequency = 5.0, Cache = 25, IntegratedGraphics = false, Name = "Intel Core i9-12700KF Processor" }, 
